...
from lurkiti.favicons import _Favicons, get_stream_icon, favicons
...
class TestFavicons(unittest.TestCase):
    ...
    @patch('lurkiti.favicons.requests.get')
    ...
    @patch('lurkiti.favicons.requests.get')
    @patch('lurkiti.favicons.QStandardPaths.writableLocation')
